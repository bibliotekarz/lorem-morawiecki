...
function start() {
    ...
    x.addEventListener("click", tareaInsert);
}


function tareaInsert() {
    document.getElementById("akapity").innerHTML = "<div class=\"tareaValue\"><p class=\"tareaValue1\">"
     + switchText() + " " + switchText() + " " + switchText() + "</p><p class=\"tareaValue1\">"
     + switchText() + " " + switchText() + " " + switchText() + "</p><p class=\"tareaValue1\">"
     + switchText() + " " + switchText() + " " + switchText() + "</p></div>";
    return
}